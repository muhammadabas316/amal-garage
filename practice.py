...
root.title("Admin")
root.iconbitmap(r'D:/amal garage/x.png')                        #project's icon
b = ImageTk.PhotoImage(file="D:/amal garage/car2.png")          #Photo used in first window's backgrounds
leb = Label(root, image=b)
leb.place(x=0, y=0, relwidth=1, relheigh=1)
#e =ImageTk.PhotoImage(file="D:/amal garage/e.jpg")
...
class Main:
    def __init__(self, master):
        f1 = Frame(master, borderwidth=1, padx= 5,pady=5)
        f1.pack(side=TOP)
...
class Employee:
    ...
    def __init__(self, master):
        ...
        self.b.pack(side= TOP,pady=20)

        #e_leb = Label(master, image=e)
        #e_leb.place(x=0, y=0, relwidth=1, relheigh=1)
...
class Services:
    ...
    def __init__(self, master):
        Button(master, text="Services", command=self.abas).pack(side= TOP ,pady=20)
def view():
    print("ABBAS")
...
class Payments:
    def __init__(self, master):
        ...
        Button(my_me, text="Payments").pack(side= TOP, pady=20)


class Appointments:
    def __init__(self, master):
        Button(master, text="Appointments").pack(side= TOP, pady=20)
