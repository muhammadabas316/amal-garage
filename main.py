...
class Main:
    def __init__(self, master):
        ...
        l1.grid(row=0, column=3,padx=10,pady=10)
        ...
        Button(f1, bg="grey", fg="black", text="Sign in", command=Print).grid(row=8, column=5,padx=10,pady=10)
        email = StringVar()
        pswrd = StringVar()
...
class Services:
    ...
    def nw(self, master):
        ...
        self.s_btn= Button(self.s_win, text="VIEW")
